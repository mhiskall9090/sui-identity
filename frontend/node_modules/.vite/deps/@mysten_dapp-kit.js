...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React38 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState18 = React38.useState, useEffect20 = React38.useEffect, useLayoutEffect7 = React38.useLayoutEffect, useDebugValue2 = React38.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React38 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef18 = React38.useRef, useEffect20 = React38.useEffect, useMemo8 = React38.useMemo, useDebugValue2 = React38.useDebugValue;
...
// node_modules/.pnpm/@mysten+dapp-kit@0.18.0_@tanstack+react-query@5.90.2_react@19.2.0__@types+react-dom@19._42fe514314a3624971bf053e2dc6e495/node_modules/@mysten/dapp-kit/dist/esm/index.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/serializer.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/Inputs.js
function Pure(data) {
  return {
    $kind: "Pure",
    Pure: {
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/Commands.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/data/v2.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/experimental/transports/json-rpc-resolver.js
  ...
  for (const [index2, input] of transactionData.inputs.entries()) {
    ...
    if (input.UnresolvedObject.initialSharedVersion ?? object2?.initialSharedVersion) {
      updated = Inputs.SharedObjectRef({
        ...
        mutable: input.UnresolvedObject.mutable || isUsedAsMutable(transactionData, index2)
      });
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/resolve.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/object.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/pure.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/utils.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/plugins/NamedPackagesPlugin.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/Transaction.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/ObjectCache.js
var _caches;
var _cache;
var _onEffects;
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/executor/caching.js
var _client;
var _lastDigest;
_client = /* @__PURE__ */ new WeakMap();
_lastDigest = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/executor/queue.js
var _queue;
var _queue2;
_queue = /* @__PURE__ */ new WeakMap();
_queue2 = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/executor/serial.js
var _queue3;
var _signer;
var _cache2;
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/executor/parallel.js
...
getUsedObjects_fn = async function(transaction) {
  ...
  await transaction.prepareForSerialization({ client: __privateGet2(this, _client2) });
  return usedObjects;
};
execute_fn = async function(transaction, usedObjects, options, additionalSignatures = []) {
  let gasCoin;
  try {
    transaction.setSenderIfNotSet(__privateGet2(this, _signer2).toSuiAddress());
    await __privateGet2(this, _buildQueue).runTask(async () => {
      ...
      transaction.setGasBudgetIfNotSet(__privateGet2(this, _defaultGasBudget2));
      ...
      await __privateGet2(this, _cache3).buildTransaction({ transaction, onlyTransactionKind: true });
    });
    const bytes = await transaction.build({ client: __privateGet2(this, _client2) });
    const { signature } = await __privateGet2(this, _signer2).signTransaction(bytes);
    const results = await __privateGet2(this, _cache3).executeTransaction({
      transaction: bytes,
    ...
    if (gasCoin && gasUsed && gasResult.owner === __privateGet2(this, _signer2).toSuiAddress()) {
      ...
      if (!usesGasCoin && remainingBalance >= __privateGet2(this, _minimumCoinBalance)) {
    ...
    __privateSet2(this, _lastDigest2, results.digest);
    return {
    ...
    await __privateMethod2(this, _ParallelTransactionExecutor_instances, updateCache_fn).call(this, async () => {
      await Promise.all([
        __privateGet2(this, _cache3).cache.deleteObjects([...usedObjects]),
...
updateCache_fn = async function(fn) {
  ...
  __privateSet2(this, _cacheLock, fn?.().then(
    () => {
...
waitForLastDigest_fn = async function() {
  const digest = __privateGet2(this, _lastDigest2);
  if (digest) {
    __privateSet2(this, _lastDigest2, null);
    await __privateGet2(this, _client2).waitForTransaction({ digest });
  }
};
...
getGasPrice_fn = async function() {
  ...
  const state = await __privateGet2(this, _client2).getLatestSuiSystemState();
...
refillCoinPool_fn = async function() {
  ...
  const address = __privateGet2(this, _signer2).toSuiAddress();
  ...
  if (__privateGet2(this, _sourceCoins)) {
    ...
    if (ids.length > 0) {
      const coins = await __privateGet2(this, _client2).multiGetObjects({
        ids
      });
      refs.push(
  ...
  const result = await __privateGet2(this, _client2).signAndExecuteTransaction({
    transaction: txb,
    signer: __privateGet2(this, _signer2),
    options: {
      showRawEffects: true
    }
  });
  ...
  await __privateGet2(this, _client2).waitForTransaction({ digest: result.digest });
};

// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/intents/CoinWithBalance.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/transactions/Arguments.js
var Arguments = {
...
// node_modules/.pnpm/@mysten+wallet-standard@0.17.0_typescript@5.8.3/node_modules/@mysten/wallet-standard/dist/esm/wallet.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.17.0_typescript@5.8.3/node_modules/@mysten/wallet-standard/dist/esm/detect.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.17.0_typescript@5.8.3/node_modules/@mysten/wallet-standard/dist/esm/chains.js
...
var DappPostMessageChannel = class {
  constructor({
    ...
    __privateAdd2(this, _listener, (event) => {
      if (event.origin !== __privateGet3(this, _hostOrigin)) {
        return;
      }
      const { success, output } = safeParse(Response, event.data);
      if (!success || output.id !== __privateGet3(this, _id)) {
        return;
      }
      __privateMethod3(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
      if (output.payload.type === "reject") {
        __privateGet3(this, _reject).call(this, new Error("User rejected the request"));
      } else if (output.payload.type === "resolve") {
        __privateGet3(this, _resolve).call(this, output.payload.data);
      }
    });
    ...
    __privateSet3(this, _hostOrigin, hostOrigin);
    __privateSet3(this, _hostPathname, hostPathname);
    __privateSet3(this, _appName, appName);
    const { promise, resolve, reject } = promiseWithResolvers();
    __privateSet3(this, _promise, promise);
    __privateSet3(this, _resolve, resolve);
    __privateSet3(this, _reject, reject);
    __privateSet3(this, _extraRequestOptions, extraRequestOptions);
    __privateSet3(this, _interval, setInterval(() => {
      try {
        if (__privateGet3(this, _popup).closed) {
          __privateMethod3(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
  ...
  send({
    ...
    if (__privateGet3(this, _isSendCalled2)) {
      throw new Error("send() can only be called once");
    }
    __privateSet3(this, _isSendCalled2, true);
    window.addEventListener("message", __privateGet3(this, _listener));
    const requestData = {
      version: __privateGet3(this, _version),
      requestId: __privateGet3(this, _id),
      appUrl: window.location.href.split("#")[0],
      appName: __privateGet3(this, _appName),
      payload: {
        type,
        ...data
      },
      metadata: getClientMetadata(),
      extraRequestOptions: __privateGet3(this, _extraRequestOptions)
    };
    const encodedRequestData = encodeURIComponent(btoa(JSON.stringify(requestData)));
    __privateGet3(this, _popup).location.assign(`${__privateGet3(this, _hostOrigin)}/${__privateGet3(this, _hostPathname)}#${encodedRequestData}`);
    return __privateGet3(this, _promise);
  }
  close() {
    __privateMethod3(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
    __privateGet3(this, _popup).close();
  }
};
...
cleanup_fn = function() {
  if (__privateGet3(this, _interval)) {
    clearInterval(__privateGet3(this, _interval));
    __privateSet3(this, _interval, null);
  }
  window.removeEventListener("message", __privateGet3(this, _listener));
};

// node_modules/.pnpm/@mysten+slush-wallet@0.2.0_typescript@5.8.3/node_modules/@mysten/slush-wallet/dist/esm/wallet/index.js
...
var SlushWallet = class {
  constructor({
    ...
    __privateAdd3(this, _signTransactionBlock, async ({
      ...
      const popup = __privateMethod4(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd3(this, _connect, async (input) => {
      ...
      __privateMethod4(this, _SlushWallet_instances, setAccounts_fn).call(this, getAccountsFromSession(response.session));
      return { accounts: this.accounts };
    });
    __privateAdd3(this, _disconnect, async () => {
      localStorage.removeItem(SLUSH_SESSION_KEY);
      __privateMethod4(this, _SlushWallet_instances, setAccounts_fn).call(this, []);
    });
    __privateSet4(this, _id2, metadata.id);
    __privateSet4(this, _accounts, __privateMethod4(this, _SlushWallet_instances, getPreviouslyAuthorizedAccounts_fn).call(this));
    __privateSet4(this, _events, mitt_default());
    __privateSet4(this, _origin, origin || DEFAULT_SLUSH_ORIGIN);
    __privateSet4(this, _name, name);
    __privateSet4(this, _walletName, metadata.walletName);
    __privateSet4(this, _icon, metadata.icon);
  }
  get name() {
    return __privateGet4(this, _walletName);
  }
  get id() {
    return __privateGet4(this, _id2);
  }
  get icon() {
    return __privateGet4(this, _icon);
  }
  get version() {
    return "1.0.0";
  }
  ...
  get features() {
    return {
      ...
      "sui:signTransaction": {
        version: "2.0.0",
        signTransaction: __privateGet4(this, _signTransaction)
      },
      "sui:signPersonalMessage": {
        version: "1.1.0",
      ...
      "sui:signAndExecuteTransaction": {
        version: "2.0.0",
        signAndExecuteTransaction: __privateGet4(this, _signAndExecuteTransaction)
      }
    };
  }
...
setAccounts_fn = function(accounts) {
  __privateSet4(this, _accounts, accounts);
...
getNewPopupChannel_fn = function() {
  return new DappPostMessageChannel({
    appName: __privateGet4(this, _name),
    hostOrigin: __privateGet4(this, _origin)
  });
};
...
// node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.2_react@19.2.0/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.2_react@19.2.0/node_modules/zustand/esm/index.mjs
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/client/errors.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/client/rpc-websocket-client.js
...
var WebsocketClient = class {
  ...
  async makeRequest(method, params, signal) {
    const webSocket = await __privateMethod5(this, _WebsocketClient_instances, setupWebSocket_fn).call(this);
    return new Promise((resolve, reject) => {
      __privateSet5(this, _requestId, __privateGet5(this, _requestId) + 1);
      __privateGet5(this, _pendingRequests).set(__privateGet5(this, _requestId), {
        resolve,
        reject,
        timeout: setTimeout(() => {
          __privateGet5(this, _pendingRequests).delete(__privateGet5(this, _requestId));
      ...
      webSocket.send(JSON.stringify({ jsonrpc: "2.0", id: __privateGet5(this, _requestId), method, params }));
    }).then(({ error, result }) => {
      if (error) {
  ...
  async subscribe(input) {
    ...
    __privateGet5(this, _subscriptions).add(subscription);
...
setupWebSocket_fn = function() {
  if (__privateGet5(this, _connectionPromise)) {
    return __privateGet5(this, _connectionPromise);
  }
  __privateSet5(this, _connectionPromise, new Promise((resolve) => {
    __privateGet5(this, _webSocket)?.close();
    __privateSet5(this, _webSocket, new this.options.WebSocketConstructor(this.endpoint));
    __privateGet5(this, _webSocket).addEventListener("open", () => {
      __privateSet5(this, _disconnects, 0);
      resolve(__privateGet5(this, _webSocket));
    });
    __privateGet5(this, _webSocket).addEventListener("close", () => {
      __privateWrapper2(this, _disconnects)._++;
      if (__privateGet5(this, _disconnects) <= this.options.maxReconnects) {
        setTimeout(() => {
          __privateMethod5(this, _WebsocketClient_instances, reconnect_fn).call(this);
        }, this.options.reconnectTimeout);
      }
    });
    __privateGet5(this, _webSocket).addEventListener("message", ({ data }) => {
      let json;
      try {
      ...
      if ("id" in json && json.id != null && __privateGet5(this, _pendingRequests).has(json.id)) {
        const { resolve: resolve2, timeout } = __privateGet5(this, _pendingRequests).get(json.id);
        clearTimeout(timeout);
        resolve2(json);
      } else if ("params" in json) {
        const { params } = json;
        __privateGet5(this, _subscriptions).forEach((subscription) => {
...
reconnect_fn = async function() {
  __privateGet5(this, _webSocket)?.close();
  __privateSet5(this, _connectionPromise, null);
  return Promise.allSettled(
    [...__privateGet5(this, _subscriptions)].map((subscription) => subscription.subscribe(this))
  );
};
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/client/http-transport.js
...
var __privateAdd5 = (obj, member, value) => member.has(obj) ? __typeError6("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
var SuiHTTPTransport = class {
  constructor(options) {
    ...
    __privateSet6(this, _options, options);
  }
  fetch(input, init) {
    const fetchFn = __privateGet6(this, _options).fetch ?? fetch;
    if (!fetchFn) {
      throw new Error(
  ...
  async request(input) {
    __privateSet6(this, _requestId2, __privateGet6(this, _requestId2) + 1);
    const res = await this.fetch(__privateGet6(this, _options).rpc?.url ?? __privateGet6(this, _options).url, {
      method: "POST",
      signal: input.signal,
      headers: {
        ...
        ...__privateGet6(this, _options).rpc?.headers
      },
      body: JSON.stringify({
        jsonrpc: "2.0",
        id: __privateGet6(this, _requestId2),
        method: input.method,
        params: input.params
      })
    });
  ...
  async subscribe(input) {
    const unsubscribe = await __privateMethod6(this, _SuiHTTPTransport_instances, getWebsocketClient_fn).call(this).subscribe(input);
    if (input.signal) {
...
getWebsocketClient_fn = function() {
  if (!__privateGet6(this, _websocketClient)) {
    const WebSocketConstructor = __privateGet6(this, _options).WebSocketConstructor ?? WebSocket;
    if (!WebSocketConstructor) {
      throw new Error(
        "The current environment does not support WebSocket, you can provide a WebSocketConstructor in the options for SuiHTTPTransport."
      );
    }
    __privateSet6(this, _websocketClient, new WebsocketClient(
      __privateGet6(this, _options).websocket?.url ?? __privateGet6(this, _options).url,
      {
        WebSocketConstructor,
        ...__privateGet6(this, _options).websocket
      }
    ));
  }
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/client/network.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/experimental/transports/jsonRPC.js
...
// node_modules/.pnpm/@mysten+sui@1.38.0_typescript@5.8.3/node_modules/@mysten/sui/dist/esm/client/client.js
...
// node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.2_react@19.2.0/node_modules/zustand/esm/middleware.mjs
...
function registerUnsafeBurnerWallet(suiClient) {
  ...
  class UnsafeBurnerWallet {
    constructor() {
      __privateAdd7(this, _on2, () => {
        return () => {
        };
      });
      __privateAdd7(this, _connect2, async () => {
        return { accounts: this.accounts };
      });
      __privateAdd7(this, _signPersonalMessage2, async (messageInput) => {
        const { bytes, signature } = await keypair.signPersonalMessage(messageInput.message);
        return { bytes, signature };
      });
      __privateAdd7(this, _signTransactionBlock2, async (transactionInput) => {
      ...
      __privateAdd7(this, _signTransaction2, async (transactionInput) => {
      ...
      __privateAdd7(this, _signAndExecuteTransactionBlock, async (transactionInput) => {
        const { bytes, signature } = await transactionInput.transactionBlock.sign({
          client: suiClient,
          signer: keypair
        });
      ...
      __privateAdd7(this, _signAndExecuteTransaction2, async (transactionInput) => {
        const { bytes, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
          client: suiClient,
    ...
    get features() {
      return {
        ...
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
          signAndExecuteTransaction: __privateGet8(this, _signAndExecuteTransaction2)
        }
      };
    }
  }
